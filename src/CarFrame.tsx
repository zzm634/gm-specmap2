...
function CarFrame(props: {
   ...
   /**
    ...
    const colorHex = `${redVal}${greenVal}${blueVal}`;

    function drawImage(context: CanvasRenderingContext2D, image: HTMLImageElement, alpha: number = 1.0, mode: GlobalCompositeOperation = "copy") {
        context.save();
